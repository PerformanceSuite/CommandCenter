...
revision = "005_add_project_analysis"
down_revision = "004_knowledgebeast_integration"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(
        "ix_project_analyses_project_path", "project_analyses", ["project_path"], unique=True
    )
    op.create_index("ix_project_analyses_analyzed_at", "project_analyses", ["analyzed_at"])
