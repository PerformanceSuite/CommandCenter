...
def upgrade() -> None:
    ...
    op.execute("UPDATE repositories SET project_id = (SELECT id FROM projects WHERE name = 'Default Project')")
    ...
    op.execute("UPDATE technologies SET project_id = (SELECT id FROM projects WHERE name = 'Default Project')")
    ...
    op.execute("UPDATE research_tasks SET project_id = (SELECT id FROM projects WHERE name = 'Default Project')")
    ...
    op.execute("UPDATE knowledge_entries SET project_id = (SELECT id FROM projects WHERE name = 'Default Project')")
    ...
    op.create_index('ix_knowledge_entries_project_id', 'knowledge_entries', ['project_id'], unique=False)

    # 7. Add project_id to webhook_configs table
    op.add_column('webhook_configs', sa.Column('project_id', sa.Integer(), nullable=True))
    op.execute("UPDATE webhook_configs SET project_id = (SELECT id FROM projects WHERE name = 'Default Project')")
    ...
    op.create_index('ix_webhook_configs_project_id', 'webhook_configs', ['project_id'], unique=False)

    # 8. Add project_id to webhook_events table
    op.add_column('webhook_events', sa.Column('project_id', sa.Integer(), nullable=True))
    op.execute("UPDATE webhook_events SET project_id = (SELECT id FROM projects WHERE name = 'Default Project')")
    ...
    op.execute("UPDATE github_rate_limits SET project_id = (SELECT id FROM projects WHERE name = 'Default Project')")
    ...
    op.create_index('ix_github_rate_limits_project_id', 'github_rate_limits', ['project_id'], unique=False)
