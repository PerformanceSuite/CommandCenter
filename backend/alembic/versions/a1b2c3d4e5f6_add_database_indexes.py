...
def upgrade() -> None:
    ...
    op.create_index(
        'idx_research_tasks_technology_id',
        'research_tasks',
        ['technology_id'],
        unique=False
    )
    ...
    op.create_index(
        'idx_research_tasks_repository_id',
        'research_tasks',
        ['repository_id'],
        unique=False
    )
    ...
    op.create_index(
        'idx_research_tasks_assigned_to',
        'research_tasks',
        ['assigned_to'],
        unique=False
    )
    ...
    op.create_index(
        'idx_knowledge_entries_technology_id',
        'knowledge_entries',
        ['technology_id'],
        unique=False
    )
    ...
    op.create_index(
        'idx_knowledge_entries_vector_db_id',
        'knowledge_entries',
        ['vector_db_id'],
        unique=False
    )
