...
class Repository(Base):
    ...
    clone_url: Mapped[Optional[str]] = mapped_column(
    ...
    last_commit_message: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True
    )
    ...
    project: Mapped["Project"] = relationship(  # noqa: F821
        "Project", back_populates="repositories"  # noqa: F821
    )
    research_tasks: Mapped[list["ResearchTask"]] = relationship(  # noqa: F821
        "ResearchTask",
        back_populates="repository",  # noqa: F821
