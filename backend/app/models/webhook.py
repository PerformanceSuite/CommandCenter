...
class WebhookConfig(Base):
    ...
    project: Mapped["Project"] = relationship(  # noqa: F821
        "Project", back_populates="webhook_configs"  # noqa: F821
    )
    repository: Mapped["Repository"] = relationship(  # noqa: F821
        "Repository", back_populates="webhook_configs"  # noqa: F821
    )
    events_received: Mapped[list["WebhookEvent"]] = relationship(  # noqa: F821
        "WebhookEvent", back_populates="config", cascade="all, delete-orphan"  # noqa: F821
    )
    deliveries: Mapped[list["WebhookDelivery"]] = relationship(  # noqa: F821
        "WebhookDelivery",
        back_populates="config",  # noqa: F821
...
class WebhookEvent(Base):
    ...
    # Relationships
    project: Mapped["Project"] = relationship(  # noqa: F821
        "Project", back_populates="webhook_events"  # noqa: F821
    )
    config: Mapped[Optional["WebhookConfig"]] = relationship(  # noqa: F821
        "WebhookConfig", back_populates="events_received"  # noqa: F821
    )
...
class WebhookDelivery(Base):
    ...
    # Relationships
    project: Mapped["Project"] = relationship(  # noqa: F821
        "Project", back_populates="webhook_deliveries"  # noqa: F821
    )
    config: Mapped["WebhookConfig"] = relationship(  # noqa: F821
        "WebhookConfig", back_populates="deliveries"  # noqa: F821
    )
...
class GitHubRateLimit(Base):
    ...
    # Relationships
    project: Mapped["Project"] = relationship(  # noqa: F821
        "Project", back_populates="github_rate_limits"  # noqa: F821
    )
