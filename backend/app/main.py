...
from app.routers import webhooks, github_features, rate_limits, research_tasks, mcp
...
app.include_router(mcp.router, prefix=settings.api_v1_prefix)  # MCP authentication (CWE-306 fix)
