...
from app.mcp.utils import MCPException, MethodNotFoundError, ParseError, InvalidRequestError
...
class JSONRPCResponse(BaseModel):
    ...
    @classmethod
    def validate_error_result_exclusion(cls, v: Optional[JSONRPCError], info) -> Optional[JSONRPCError]:
...
class MCPProtocolHandler:
    ...
    def create_invalid_request_error(
        ...
        """
        return self.create_error_response(
            request_id, self.INVALID_REQUEST, "Invalid Request", "Request validation failed"
        )
