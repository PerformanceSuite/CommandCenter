...
"""
    ...
    def test_export_with_custom_path_json(self, mock_api, runner, mock_config, mock_analysis_result, tmp_path):
        ...
        result = runner.invoke(
            cli,
            ['--config', str(mock_config), 'analyze', 'project', str(test_dir),
    ...
    @patch('cli.commands.analyze.APIClient')
    def test_export_with_custom_path_yaml(self, mock_api, runner, mock_config, mock_analysis_result, tmp_path):
        ...
        result = runner.invoke(
            cli,
            ['--config', str(mock_config), 'analyze', 'project', str(test_dir),
             '--export', 'yaml', '--output', str(output_file)]
        )
    ...
    @patch('cli.commands.analyze.APIClient')
    def test_export_creates_parent_directories(self, mock_api, runner, mock_config, mock_analysis_result, tmp_path):
    ...
    @patch('cli.commands.analyze.APIClient')
    def test_export_with_relative_path(self, mock_api, runner, mock_config, mock_analysis_result, tmp_path):
        ...
        with runner.isolated_filesystem(temp_dir=tmp_path):
            result = runner.invoke(
                cli,
                ['--config', str(mock_config), 'analyze', 'project', str(test_dir),
                 '--export', 'json', '--output', 'results/analysis.json']
            )
    ...
    @patch('cli.commands.analyze.APIClient')
    def test_export_default_path_without_output_flag(self, mock_api, runner, mock_config, mock_analysis_result, tmp_path):
    ...
    @patch('cli.commands.analyze.APIClient')
    def test_export_short_flag_alias(self, mock_api, runner, mock_config, mock_analysis_result, tmp_path):
    ...
    @patch('cli.commands.analyze.APIClient')
    def test_export_overwrites_existing_file(self, mock_api, runner, mock_config, mock_analysis_result, tmp_path):
    ...
    @patch('cli.commands.analyze.APIClient')
    def test_export_with_github_repo(self, mock_api, runner, mock_config, mock_analysis_result, tmp_path):
        ...
        result = runner.invoke(
            cli,
            ['--config', str(mock_config), 'analyze', 'project',
    ...
    @patch('cli.commands.analyze.APIClient')
    def test_export_json_is_pretty_printed(self, mock_api, runner, mock_config, mock_analysis_result, tmp_path):
