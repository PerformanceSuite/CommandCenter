...
const AIToolsView = lazy(() => import('./components/AITools/AIToolsView').then(m => ({ default: m.AIToolsView })));
const DevToolsView = lazy(() => import('./components/DevTools/DevToolsView').then(m => ({ default: m.DevToolsView })));
